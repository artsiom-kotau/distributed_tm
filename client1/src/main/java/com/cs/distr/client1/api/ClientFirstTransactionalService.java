 ...
 */
public class ClientFirstTransactionalService implements ITransactionalService {

    private static final long serialVersionUID = -979361335059685765L;
    ...
    public ClientFirstTransactionalService(String serviceId) {
